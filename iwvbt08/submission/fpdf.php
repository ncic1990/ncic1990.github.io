...
var $widths;             //largeur des colonnes d'un tableau
var $aligns;             //alignement des colonnes
...
/*-----------Méthode de construction d'un tableau en multicell.------------*/
...
function  Justify($text,$w,$h)
{
    ...
    while ($j<$nb_paragraphe) {
        ...
        // *** Gestion des chaines plus longues que la largeur de la colonne
        $k=0;
        $l=0;
        while ($k<$nb_mot) {
