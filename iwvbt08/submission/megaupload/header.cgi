...
$php_uploader="http://localhost/myreview/SubmitPaper.php"; # CHANGE THIS TO YOUR PHP SCRIPTS URL

$interval=1;				  # how often to refresh the progress bar

# Changed by GFW on Jan 24, 2006
#$max_upload = 5000000; # set this to whatever you feel suitable for you.
$max_upload = 20000000; # set this to whatever you feel suitable for you.
