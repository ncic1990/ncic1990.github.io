...
var postLocation="/myreview/megaupload/pgbar.php";
...
function postIt()
{
	...
	if (document.forms[0].file.value!="") popUP(baseUrl,"Uploader",460,140,false,false);
	else document.forms[0].action="SubmitPaper.php";
